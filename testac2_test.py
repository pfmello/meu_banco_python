...
def test_cliente_atualiza_telefone_com_erro(telefone):
    ...
    try:
        ...
        raise AssertionError(
            'Erro diferente de TypeError/ValueError para telefone inválido')
    finally:
...
def test_cliente_atualiza_email_com_erro(email):
    ...
    try:
        ...
        raise AssertionError(
            'Erro diferente de TypeError/ValueError para email inválido')
    finally:
...
def test_cria_conta():
    try:
        c1 = Mock(nome='Cliente 1', telefone='11 9999-9999',
                  email='cliente1@mail.com')
        c2 = Mock(nome='Cliente 2', telefone='11 9999-8888',
...
def test_conta_saque_invalido(valor):
    ...
    try:
        ...
        raise AssertionError(
            'Erro diferente de ValueError para saque inválido')
    else:
...
def test_cria_banco():
    try:
        ...
        assert hasattr(
            b, 'abrir_conta'), 'Não criou o método público abrir_conta'
